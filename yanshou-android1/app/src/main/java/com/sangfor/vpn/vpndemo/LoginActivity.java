...
public class LoginActivity extends com.sangfor.vpn.vpndemo.BaseCheckPermissionActivity implements LoginResultListener, RandCodeListener {
    ...
    private void initClickEvents() {
        ...
        mTicketLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(LoginActivity.this, "开启ByPass", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void doResourceRequest() {
        startActivity(new Intent(LoginActivity.this, com.sangfor.vpn.vpndemo.AuthSuccessActivity.class));
    }
